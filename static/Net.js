...
function base64_2() {
    ...
    function f(j) {
        ...
        for(var h = 0; h < j.length; h++) {
            g += String.fromCharCode(parseInt(j[h]));
        }
        return g;
    }
...
function base64encode(a) {
    return ___b64_2.encode(a);
}

function base64decode(a) {
    return ___b64_2.decode(a);
}
...
var leaprpcclient = function() {
    ...
    this.___buildResult = function(m, l, h) {
        this.isSuccess = 1;
        this.lastError = null;
        this.lastErrorCode = null;
        if(h && h.getResponseHeader("error")) {
            m = "{isSuccess:0,lastErrorCode:'" + h.getResponseHeader("error") + "',javaClass:'e'}";
        }
        if(m == null || m == "" || m == "null") {
            this.isSuccess = 0;
        ...
        if(l == null) {
            ...
            try {
                ...
                if(e != null && e.javaClass) {
                    ...
                    if(e.dataType != null && e.dataType == 12) {
                        l = false;
                    }
                    if(l) {
                        var j = null;
    ...
    this.getsid = function() {
        return "96ED18EC2B630B67A011B1C0DAF0BCE6.05";
        if(this.sid == null) {
    ...
    this.request = function(B, r, G, l, t, i, f, q, x, p, z) {
        var D = null;
        var g = null;
        if(t == null) {
            D = this.Service;
        ...
        if(G != null) {
            n += "&extend=" + encodeURIComponent(encodeURIComponent(escape(G)));
        }
        if(!this.initsafe) {
        ...
        if(this.safe != null) {
            var A = (Math.round(_safeprop.random() * 10000)) + "";
            while(A.length < 4) {
                A += "0";
            }
            n += "&zz=" + (A);
        ...
        try {
            if(l == null) {
                var y = null;
                var s = XmlHttpHelper._getXmlHttpObj();
                if(x == true) {
                    y = XmlHttpHelper.GetTextByGet(B, null, null, null, null, null, s);
                } else {
                    y = XmlHttpHelper.GetTextByPost(leapconfig.rpcurl(), n, h, null, null, null, s);
                }
                if(w) {
                    return this.___buildResult(y, true, s);
                } else {
                    return y;
                }
            } else {
                ...
                var s = XmlHttpHelper._getXmlHttpObj();
                if(x == true) {
                    XmlHttpHelper.GetTextByGet(B, null, null, this.callbackfunction, this, {
                        callback: l,
                        domain: p,
                        args: z,
                        instance: F,
                    ...
                    XmlHttpHelper.GetTextByPost(leapconfig.rpcurl(), n, h, this.callbackfunction, this, {
                        callback: l,
                        domain: p,
                        args: z,
                        instance: F,
                ...
                leaprpcclientasyncactivelist.add(F);
                return F;
            }
        } catch(j) {
            if(l != null) {
        ...
        if((!window.LEAP_LID || ((b.indexOf("http://") == 0 || b.indexOf("https://") == 0) && (b.indexOf(leapconfig.server) == -1 || b.toLowerCase().indexOf("login.html") > -1)))) {} else {
            if(b.indexOf(".html") > -1 || b.indexOf(".htm") > -1 || b.endsWith("/")) {
                if(b.indexOf("&lid=") == -1 && b.indexOf("?lid=") == -1) {
                    var a = b.indexOf("?");
                    if(a > -1) {
                        b = b.substring(0, a + 1) + "lid=" + window.LEAP_LID + "&" + b.substring(a + 1);
                    } else {
                        b += "?lid=" + window.LEAP_LID;
                    }
                }
            }
        }
...
XmlHttpHelper.transmit = function(f, s, c, b, a, h, g, p, u, o) {
    var z = null;
    var F = o;
    if(F == null) {
        F = this._getXmlHttpObj();
    }
    try {
        var j = f;
        if(c != null) {
        ...
        if(!XmlHttpHelper.isChrome) {
            F.setRequestHeader("connection", "keep-alive");
        }
        ...
        if(window.LEAP_LID) {
            F.setRequestHeader("LID", window.LEAP_LID);
        }
        var d = false;
                ...
                try {
                    ...
                    if(leapflash.fp != null && leapflash.fp.compress != null && b.length > 1000) {
                        if(!(XmlHttpHelper.isIE && XmlHttpHelper.IEVersion == 8)) {
                            ...
                            F.setRequestHeader("Data-Type", "2");
                        }
                    }
                    if(!y && b.length > 0) {
                        if(!(XmlHttpHelper.isIE && XmlHttpHelper.IEVersion == 8)) {
                            b = "a=" + base64encode(encodeURIComponent(escape(b)));
                            F.setRequestHeader("Data-Type", "4");
                        } else {
                            b = "a=" + encodeURIComponent(escape(b));
                            F.setRequestHeader("Data-Type", "5");
                        }
                    }
                } catch(w) {}
                F.setRequestHeader("Post-Type", "1");
                q = b.length;
            }
            if(!XmlHttpHelper.isChrome) {
                F.setRequestHeader("Content-Length", '"' + q + '"');
            }
        ...
        if(window._leap_systemarea) {
            F.setRequestHeader("LSYS-AREA", window._leap_systemarea);
        }
        if(window._leap_systemname) {
            F.setRequestHeader("LSYS-NAME", window._leap_systemname);
        }
        if(window._leap_systemcode) {
            F.setRequestHeader("LSYS-CODE", window._leap_systemcode);
        }
        if(h) {
            if(u != null && u.instance != null) {
                z = u.instance;
            }
            F.onreadystatechange = function() {
                XmlHttpHelper.processLID(F);
                if(F.readyState == 4) {
                    try {
                        if(a != null) {
                            if(a.toLowerCase() == "text") {
                                if(g != null) {
                                    if(p != null) {
                                        if(z == null || (z != null && leaprpcclientasyncactivelist.contains(z))) {
                                            var e = F.responseText;
                                            if(F.getResponseHeader("LENC")) {
                                                if(d) {
                                                    if(e) {
                                                        e = leapflash.fp.d(e);
                                                        if(e) {
                                        ...
                                        if(z != null) {
                                            leaprpcclientasyncactivelist.remove(z);
                                        }
                                    } else {
                                        var e = F.responseText;
                                        if(F.getResponseHeader("LENC")) {
            ...
            if(F.status == 200) {
                if(a != null) {
                    if(a.toLowerCase() == "text") {
                        ...
                        var n = F.getResponseHeader("ServerTime997");
                        if(n != null && n.length > 0) {
                            return F.responseText + ":" + n;
                        } else {
